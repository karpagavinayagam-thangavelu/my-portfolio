...
const myStepDetails = (step: number) => {
    switch (step) {
        case 0: return <ILP/>; 
        case 1: return <TIPP/>;
        default: return (<Rogers/>); 
    }
};

export const TCSDetails = () => (
    <React.Fragment>
        <DialogTitle id="TCS"><Typography variant="h3">Tata Consultancy Services </Typography></DialogTitle>
        <DialogContent>
            <DialogContentText >
...
export const ILP = () => {
    const headers = [ "Designation","Role", "Period", "Responsibility", "Learning Outcomes", "Achievements"];
    const entries = [
            ...
            <ul>
                ...
                <li>To complete a Project on `<i>Online Exam Management System</i>` </li>
                <li>To manage the development team and guide on the website development</li>
            </ul>,
            <ul>
...
export const TIPP = () => {
    ...
    const entries = [
            ...
            <ul>
                <li>To resolve bug fixes and support changes in Target Procurement Process Applications </li>
                <li>To maintain DB Upgrades and enhance the application with client requirements </li>
                <li>To program scheduled Batch processing with Java Spring Batch to mine the purchase details from oracle to DB2 </li>
            </ul>,
            <ul>
            ...
            <ul>
                <li>Have learnt and implemented Spring Batch job and completed the project in short duration</li>
                <li>Created a automation script for DB2 Patch Generation by every week with provided excels. This reduces a 3 man days effort each week. </li>
            </ul>
        ];
    return(<section id="ilp">
        <RowTable headers={headers} rowEntries={entries}/>
...
export const Rogers = () => {
    ...
    const entries = [
            ...
            <ul>
                ...
                <li>Have got appreciation for interactive session on AngularJS and Play Framework. </li>
            </ul>
        ];
    return(<section id="ilp">
        <RowTable headers={headers} rowEntries={entries}/>
