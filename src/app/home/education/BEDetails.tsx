...
export const BEDetails = () => (
  <React.Fragment>
    <DialogTitle id="BE" variant="h3">
      Bachelor of Technology
    </DialogTitle>
    <DialogContent>
      <DialogContentText>
        Have completed B. Tech in Computer science and Engineering at
        Kalasalingam Academy of Research and Education with Honours and
        Distinction
      </DialogContentText>
      ...
      <section className="co-curricular">
        ...
        <ul>
          <li>
            Completed Cambridge ESOL Entry level certificate in Business English
          </li>
          <li>
            Got certified as IBM Solution designer for Rational Functional
            Testing in Java
          </li>
          <li>
            Completed Web designing, Core JAVA, Advanced JAVA, XML, J2EE Course
            in Apollo Computer Education
          </li>
          <li>
            Completed IBM DB2 fundamental course by IBM Software center of
            Excellence
          </li>
        </ul>
      </section>
      <section className="extra-curricular">
        ...
        <ul>
          <li>
            ...
            <i>"Improving Time Efficiency in Adhoc Networks"</i> in INGINEA'2010
            at Kalasalingam University
          </li>
