...
const interests = [
    "Mathematics and Statistics", "Parallel Programming Paradigm", "Advanced Datastructures and Algorithms", "Machine learning"
];

export const MEDetails = () => (
    <React.Fragment>
        <DialogTitle id="ME"><Typography variant="h3">Master of Engineering</Typography></DialogTitle>
        <DialogContent>
            <DialogContentText >
                Have completed M.E. in Computer science and Engineering at Mepco schlenk Engineering college with First class and Distinction
                ...
                <section className="co-curricular">
                    ...
                    <ul>
                        <li>Got certified in Global English Testing services with Level IV score of CEFR B2 </li>
                        <li>Participated in National Seminar on Reaearch issues in Digital Image processing.</li>
                    </ul>
                </section>
                <section className="extra-curricular">
                    <Typography variant="h5" variantMapping={{"h5": "h4"}}>Extra-curricular</Typography>
                    <ul>
                        <li>Presented a Paper on <i>"Subspace based Generic object identification and classification"</i> in IEE Sponsored International conference on Engineering and Technology at Karpagam college of Engineering, Coimbatore.</li>
                        <li>Conducted Software Engineering in practice classes.</li>
                        <li>Worked as a Intern for 6 months in <i>Spime India Technologies</i> on Ecognition project and FFT Spectrum Analyzer Project</li>
                    </ul>
                </section>
            </DialogContentText>
        </DialogContent>
